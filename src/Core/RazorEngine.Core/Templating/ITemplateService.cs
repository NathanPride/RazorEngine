namespace RazorEngine.Templating
{
    ...
    public interface ITemplateService : IDisposable
    {
        ...
        /// <param name="cacheName">The name of the template type in the cache or NULL if no caching is desired.</param>
        /// <returns>The string result of the template.</returns>
        void ParseToWriter(TextWriter writer, string razorTemplate, object model, DynamicViewBag viewBag, string cacheName);
        ...
        /// <param name="cacheName">The name of the template type in the cache or NULL if no caching is desired.</param>
        /// <returns>The string result of the template.</returns>
        void ParseToWriter<T>(TextWriter writer, string razorTemplate, object model, DynamicViewBag viewBag, string cacheName);
        ...
        /// <param name="viewBag">The initial ViewBag contents NULL for an empty ViewBag.</param>
        /// <returns>The string result of the template.</returns>
        void RunToWriter(TextWriter writer, string cacheName, object model, DynamicViewBag viewBag);
        ...
        /// <param name="viewBag">The ViewBag contents or NULL for an initially empty ViewBag.</param>
        /// <returns>The string result of the template.</returns>
        void RunToWriter(TextWriter writer, ITemplate template, DynamicViewBag viewBag);
